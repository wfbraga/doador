...
class EntradasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entrada" do
    assert_difference('Entrada.count') do
      post entradas_url, params: { entrada: { categoria: @entrada.categoria, data: @entrada.data, descricao: @entrada.descricao, valor: @entrada.valor } }
    end
  ...
  test "should update entrada" do
    patch entrada_url(@entrada), params: { entrada: { categoria: @entrada.categoria, data: @entrada.data, descricao: @entrada.descricao, valor: @entrada.valor } }
